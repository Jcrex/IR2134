...
class FleetManager(Node):
    ...
    def __init__(self, config):
        ...
        @app.get('/open-rmf/psychology_uv_fm/status/', response_model=Response)
        ...
        @app.post('/open-rmf/psychology_uv_fm/navigate/', response_model=Response)
        ...
        @app.get('/open-rmf/psychology_uv_fm/stop_robot/', response_model=Response)
        ...
        @app.get(
            '/open-rmf/psychology_uv_fm/action_paths/', response_model=Response
        )
        ...
        @app.post(
            '/open-rmf/psychology_uv_fm/start_activity/', response_model=Response
        )
        ...
        @app.post(
            '/open-rmf/psychology_uv_fm/toggle_teleop/', response_model=Response
        )
        ...
        @app.post(
            '/open-rmf/psychology_uv_fm/toggle_attach/', response_model=Response
        )
