...
class RobotAPI:
    ...
    def navigate(
        ...
        url = (
            self.prefix
            + f'/open-rmf/industrial_upc_fm/navigate?robot_name={robot_name}'
            f'&cmd_id={cmd_id}'
        )
    ...
    def start_activity(
        ...
        url = (
            self.prefix
            + f'/open-rmf/industrial_upc_fm/start_activity?robot_name={robot_name}'
            f'&cmd_id={cmd_id}'
        )
    ...
    def stop(self, robot_name: str, running_cmd_id: int, stop_cmd_id: int):
        ...
        url = (
            self.prefix
            + f'/open-rmf/industrial_upc_fm/stop_robot?robot_name={robot_name}'
    ...
    def toggle_teleop(self, robot_name: str, toggle: bool):
        ...
        url = (
            self.prefix
            + f'/open-rmf/industrial_upc_fm/toggle_teleop?robot_name={robot_name}'
        )
        data = {'toggle': toggle}
        try:
            response = requests.post(url, timeout=self.timeout, json=data)
    ...
    def toggle_attach(self, robot_name: str, attach: bool, cmd_id: int):
        ...
        url = (
            self.prefix
            + f'/open-rmf/industrial_upc_fm/toggle_attach?robot_name={robot_name}'
            f'&cmd_id={cmd_id}'
        )
        data = {'toggle': attach}
        try:
    ...
    def get_data(self, robot_name: str | None = None):
        ...
        if robot_name is None:
            url = self.prefix + '/open-rmf/industrial_upc_fm/status'
        else:
            url = (
                self.prefix
                + f'/open-rmf/industrial_upc_fm/status?robot_name={robot_name}'
            )
        try:
