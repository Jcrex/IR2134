...
class FleetManager(Node):
    ...
    def __init__(self, config):
        ...
        @app.get('/open-rmf/industrial_upc_fm/status/', response_model=Response)
        ...
        @app.post('/open-rmf/industrial_upc_fm/navigate/', response_model=Response)
        ...
        @app.get('/open-rmf/industrial_upc_fm/stop_robot/', response_model=Response)
        ...
        @app.get(
            '/open-rmf/industrial_upc_fm/action_paths/', response_model=Response
        )
        ...
        @app.post(
            '/open-rmf/industrial_upc_fm/start_activity/', response_model=Response
        )
        ...
        @app.post(
            '/open-rmf/industrial_upc_fm/toggle_teleop/', response_model=Response
        )
        ...
        @app.post(
            '/open-rmf/industrial_upc_fm/toggle_attach/', response_model=Response
        )
